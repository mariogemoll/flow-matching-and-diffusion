...
export const VECTOR_FIELD_MIN_ARROW_LENGTH = 5; // Minimum arrow length in pixels
export const VECTOR_FIELD_MAX_ARROW_LENGTH = 18; // Maximum arrow length in pixels
